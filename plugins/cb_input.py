...
regex_pattern = (
    r"^(docs_yes_btn|docs_no_btn|audio_yes_btn|audio_no_btn|video_yes_btn|video_no_btn"
...
async def set_types(client: Bot, cb: CallbackQuery):
    ...
    await cb.message.edit_text(
        Presets.SELECT_TYPE, reply_markup=InlineKeyboardMarkup(opt_type_btns)
    )
